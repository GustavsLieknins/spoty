<x-app-layout>
    <div class="flex flex-col items-center justify-center py-12 bg-gradient-to-br from-black via-gray-900 to-gray-950 transition-colors duration-300">
        ...
        <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 w-full px-4 md:px-0">
            ...
            <a href="{{ $artist['external_urls']['spotify'] }}" target="_blank" class="transform hover:scale-105 transition-transform duration-300 flex flex-col items-center justify-center">
                <li class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300 w-full h-full">
